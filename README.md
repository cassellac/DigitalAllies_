...
2. Run `npm run sync-cms` locally (or rely on the automated **Sync Pages CMS content** GitHub Action) to regenerate the HTML pages under `content/posts/` and refresh `content/blog-index.json`.
